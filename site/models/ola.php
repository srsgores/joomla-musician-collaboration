...
class OlaModelOla extends JModelItem
{
	...
	public function getItem()
	{
		...
		if (!isset($this->item))
		{
			...
			$this->_db->setQuery($this->_db->getQuery(true)->from('#__ola as h')->leftJoin('#__categories as c ON h.catid=c.id')->select('h.bemvindo, h.params, c.title as category')->where('h.id=' . (int)$id));
